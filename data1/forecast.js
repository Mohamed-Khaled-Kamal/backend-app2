...
const forecast = (laititude, longtitude, callback) => {
  const url ="https://api.weatherapi.com/v1/current.json?key=e8cfb077008e4b74bc7174056241507&q=" +laititude +"," +longtitude;
